...
RESULTS_PATH = (
    ARTIFACT_DIR / f"bgl_only_few_shot_baseline_seed_{SEED}.json"
)
...
def main() -> None:
    ...
    all_results = {
        "experiment": "bgl_only_few_shot_baseline",
        "training_domain": "BGL",
    ...
    print("BGL-Only Few-Shot Baseline")
    print("=" * 28)
    ...
    for support_size in SUPPORT_SIZES:
        ...
        model_path = (
            ARTIFACT_DIR
            / f"bgl_only_support_{support_size}.joblib"
        )
        ...
        all_results["runs"][str(support_size)] = {
            ...
            "final_test_selective": selective,
